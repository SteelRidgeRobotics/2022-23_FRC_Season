...
class Joysticks(commands2.CommandBase):
    ...
    def __init__(self, 
                 robotcontainer: SwerveWheel, 
                 LeftX: typing.Callable[[], float],
                 LeftY: typing.Callable[[], float], 
                 RightX: typing.Callable[[], float],
                 RightY: typing.Callable[[], float]) -> None:
    ...
    def execute(self) -> None:
        ...
        wpilib.SmartDashboard.putNumber(
            "   LeftX - ", conversions.deadband(self.leftx(), 
                                                constants.kdeadband))
        wpilib.SmartDashboard.putNumber(
            "   Left Y - ", conversions.deadband(self.lefty(), 
                                                 constants.kdeadband))
        wpilib.SmartDashboard.putNumber(
            "   RightX - ", conversions.deadband(self.rightx(), 
                                                 constants.kdeadband))
        wpilib.SmartDashboard.putNumber(
            "   Right Y - ", conversions.deadband(self.righty(), 
                                                  constants.kdeadband))
