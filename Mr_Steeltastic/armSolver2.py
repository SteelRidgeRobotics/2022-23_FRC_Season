...
class ArmSolver2:
    ...
    def __init__(self, baseX, baseY, length1, length2):
        ...
        self.joints = [
                    ...
                    [self.baseX + self.length1 * math.cos(self.theta1) + self.length2 * math.cos(self.theta1 + self.theta2), 
                    self.baseY + self.length1 * math.sin(self.theta1) + self.length2 * math.sin(self.theta1 + self.theta2)]
                    ]
