...
class DriveByJoystick(commands2.CommandBase):
    ...
    def __init__(self, drive: Drivetrain, left_axis: typing.Callable[[], float], right_axis: typing.Callable[[], float],
                 bumperRight: typing.Callable[[], bool], bumperLeft: typing.Callable[[], bool]) -> None:
    ...
    def execute(self) -> None:
        ...
        wpilib.SmartDashboard.putBoolean('R Bumper', self.bumperRight())
        wpilib.SmartDashboard.putBoolean('L Bumper', self.bumperLeft())
        wpilib.SmartDashboard.putNumber('Speed % - ', self.percent)
